...
--------------------------
Konvertera en lista av notvärden till ett hierarkiskt rytmträd.

<rhythm> är en lista av notvärden som bråk.
<timesigns> är antingen en lista av taktartssignaturer, eller en 
taktartssignatur.

Om en lista av taktartssignaturer ges kommer denna sekvens at användas. 
Om endast en taktartssignatur ges kommer denna att användas så många 
gånger som behövs för att notera sekvensen.
"
  :icon 351
