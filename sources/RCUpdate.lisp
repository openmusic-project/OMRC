...
--------------------------
Regel fšr att tvinga ett skikt i en stŠmma att kalkyleras fšre ett 
annat skikt i samma stŠmma upp till en bestŠmd punkt. DŠrefter 
fungerar regeln pŒ samma sŠtt som r-eqlength.

<layer1> Šr numret fšr skiktet som berŠknas fšrst.
<layer2> Šr numret fšr skiktet som sedan berŠknas.
<endtime> Šr punkten dit det fšrsta skiktet ska ha nŒtt innan 
det andra skiktet bšrjar berŠknas. Anges som notvŠrde (ratio).

Regeln fungerar ocksŒ fšr skikt 0 (taktarterna).
...
--------------------------
Regel fšr att tvinga ett skikt i en stŠmma att kalkyleras fšre ett 
annat skikt i en annan stŠmma upp till en bestŠmd punkt. DŠrefter 
fungerar regeln pŒ samma sŠtt som r-eqlength.

<layer1> Šr numret fšr skiktet som berŠknas fšrst.
<voice1> Šr numret fšr stŠmman fšr skiktet som berŠknas fšrst.
<layer2> Šr numret fšr skiktet som sedan berŠknas.
<voice2> Šr numret fšr stŠmman fšr skiktet som sedan berŠknas.
<endtime> Šr punkten dit det fšrsta skiktet ska ha nŒtt innan 
det andra skiktet bšrjar berŠknas. Anges som notvŠrde (ratio).

Regeln fungerar ocksŒ fšr skikt 0 (taktarterna).

Regeln mŒste kopplas till ingŒngen fšr de bŒda skikten pŒ Òrules->pmcÓ.
...
previous measure).
--------------------------
Regel fšr att kontrollera positionen fšr den fšrsta hŠndelsen (not eller paus) 
efter ett taktstreck, d.v.s. kontroll av synkoper šver taktstreck.

<rhythm-layer-nr> Šr numret pŒ det rytmskikt som regeln gŠller fšr.
<allowed-syncopes> Šr en lista med mšjliga positioner fšr den
fšrsta hŠndelsen efter ett taktstreck. De Šr definierade som
en offset (notvŠrde som ett brŒk) frŒn taktstrecket.
<special-case> Šr en popup meny dŠr man kan vŠlja om det Šr
tillŒtet att en takt inte har nŒgra hŠndelser, d.v.s. att
inga startpunkter fšr hŠndelser intrŠffar i takten.

Ex: Om den andra ingŒngen Šr '(0 1/8), och no-empty-measures Šr vald
pŒ tredje ingŒngen, mŒste varje ny takt antingen starta med en ny
hŠndelse pŒ fšrsta slaget, eller ha fšrsta hŠndelsen en Œttondelsnot 
efter taktstrecket (den fšrsta Œttondelsnoten Šr dŒ šverbunden frŒn 
fšregŒende takt). 
...
--------------------------
HŠmta \"voice\" numret fšr den aktuella instancierade variabeln.
...
--------------------------
Regel fšr att bygga ett pattern.

<layer> Šr numret pŒ det rytmskikt som \"mšnstret\" ska byggas.
<nr-of-ev> Šr antalet rytmiska hŠndelser (noter eller pauser) i mšnstret.
<duration> Šr mšnstrets lŠngd.

Ex: Om nr-of-ev Šr 4 och duration 1, sŒ kommer ett mšnster med
den totala lŠngden en helnot med 4 rytmhŠndelser att byggas
(och upprepas i oŠndlighet) i skiktet.
