...
<subdiv>). 
--------------------------
Regel fšr att kontrollera underdelningarna av pulsslag i takter.

<rhythm-layer-nr> Šr numret pŒ det rytmskikt som regeln gŠller fšr.
<beatvalue1> och <subdiv1> hšr ihop i par (kan expanderas upp till maximalt 5 
par). <subdiv1> Šr en lista av mšjliga underdelningar av ett pulsslag i en 
takt. <beatvalue1> Šr lŠngden pŒ pulsslaget (d.v.s. den undre siffran i 
taktartssignaturen) som avses. 

Exempel: Om <beatvalue1> = 4 anger <subdiv1> hur pulsslagen i en taktart med 
pulsvŠrdet en fjŠrdedelsnot (t.ex. 4//4, 3//4) kan underdelas. Om 
<subdiv1> = (1 2 3 4 5) betyder det att pulsslaget kan underdelas ner till 
maximalt en kvintol, dock endast om denna hamnar pŒ slaget (d.v.s. inte som 
synkop). I exemplet pŒverkar inte denna regel takter med taktarter som har 
t.ex. Œttondelsnot som pulsvŠrde; varje pulsvŠrde mŒste definieras separat 
